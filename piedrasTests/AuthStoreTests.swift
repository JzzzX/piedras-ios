...
struct AuthStoreTests {
    ...
    func authenticateCreatesNewAccountWhenEmailIsNotRegistered() async {
        ...
        apiClient.registerResult = .success(
            RemoteAuthResponse(
                ...
                workspace: .init(id: "workspace-new", name: "Piedras"),
                session: .init(
                    token: "session-token",
                    refreshToken: "refresh-token",
    ...
    func authenticateFallsBackToLoginWhenAccountAlreadyExists() async {
        ...
        apiClient.loginResult = .success(
            RemoteAuthResponse(
                ...
                workspace: .init(id: "workspace-existing", name: "Piedras"),
                session: .init(
                    token: "session-token",
                    refreshToken: "refresh-token",
                    expiresAt: Date(timeIntervalSince1970: 1_000)
    ...
    func registerAwaitingEmailVerificationDoesNotAuthenticateTheStore() async {
        ...
        apiClient.registerResult = .success(
            RemoteAuthResponse(
                ...
                workspace: .init(id: "workspace-verify", name: "Piedras"),
    ...
    func restoreSessionRefreshesWhenAccessTokenHasExpired() async {
        ...
        apiClient.refreshResult = .success(
            RemoteAuthResponse(
                ...
                workspace: .init(id: "workspace-refresh", name: "Piedras"),
                session: .init(
                    token: "fresh-token",
    ...
    func registerWithEmailOTPWaitsForOptionalPasswordSetup() async {
        ...
        apiClient.emailOTPRegisterResult = .success(
            RemoteAuthResponse(
                ...
                workspace: .init(id: "workspace-otp", name: "Piedras"),
                session: .init(
                    token: "otp-token",
    ...
    func authCallbackPersistsTokensAndAuthenticatesStore() async {
        ...
        let callbackURL = URL(
            string: "piedras://auth/callback#access_token=access-token&refresh_token=refresh-token&type=signup"
        )!
    ...
    func authCallbackWithoutTokensIsIgnored() async {
        ...
        let callbackURL = URL(string: "piedras://auth/callback?type=signup")!
