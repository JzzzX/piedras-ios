...
struct SchemaMigrationCompatibilityTests {
    ...
    func currentSchemaOpensStoreCreatedWithoutImageTextFields() throws {
        ...
        #expect(meetings.first?.audioEnhancedNotes == "")
        #expect(meetings.first?.audioEnhancedNotesStatus == .idle)
        #expect(meetings.first?.audioEnhancedNotesError == "")
        #expect(meetings.first?.audioEnhancedNotesUpdatedAt == nil)
        #expect(meetings.first?.audioEnhancedNotesProvider == nil)
        #expect(meetings.first?.audioEnhancedNotesModel == nil)
