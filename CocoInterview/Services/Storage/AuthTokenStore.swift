...
final class UserDefaultsAuthTokenStore: AuthTokenStoring {
    private enum Key {
        static let sessionToken = "cocointerview.auth.sessionToken"
        static let refreshToken = "cocointerview.auth.refreshToken"
    }
...
final class KeychainAuthTokenStore: AuthTokenStoring {
    ...
    init(
        service: String = Bundle.main.bundleIdentifier ?? "io.iftech.cocointerview",
