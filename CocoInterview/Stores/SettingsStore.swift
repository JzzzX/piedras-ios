...
final class SettingsStore {
    ...
    private enum Key {
        static let hiddenWorkspaceID = "cocointerview.settings.hiddenWorkspaceID"
        static let defaultCollectionID = "cocointerview.settings.defaultCollectionID"
        static let recentlyDeletedCollectionID = "cocointerview.settings.recentlyDeletedCollectionID"
        static let selectedCollectionID = "cocointerview.settings.selectedCollectionID"
        static let appLanguage = "cocointerview.settings.appLanguage"
        static let remoteStatusSnapshot = "cocointerview.settings.remoteStatusSnapshot"
        static let syncStatusSnapshot = "cocointerview.settings.syncStatusSnapshot"
#if DEBUG
        static let debugBackendBaseURLString = "cocointerview.settings.debugBackendBaseURLString"
#endif
    }
